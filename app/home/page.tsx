  ...
  const useCases: Record<UseCaseKey, UseCase> = {
    ...
    'ai-feedback-assistant': {
      ...
      results: {
        ...
        description:
          'Transform interviews into learning opportunities for improvement and career development.',
      },
    },
    'analytics-insights': {
  ...
  return (
    <div className='min-h-screen flex flex-col bg-white text-black'>
      ...
      <header className='relative overflow-hidden px-6 py-20 text-center'>
        ...
        >
          Hirelytics bridges recruiters and applicants with real-time status updates, automated AI
          feedback, and a shared view of progress—so everyone knows what&apos;s happening and why.
        </motion.p>
                  ...
                  background:
                    f.color === 'teal'
                      ...
                      : f.color === 'pink'
                        ...
                        : `${accents.gold}33`,
                  color:
                    f.color === 'teal' ? '#0b6e77' : f.color === 'pink' ? '#7a1b57' : '#6f5b00',
                }}
              >
                {f.icon}
              </div>
        ...
        >
          <div className='flex flex-col lg:flex-row'>
            <div className='w-full p-8 lg:w-1/2 lg:p-10'>
              ...
              <p className='mb-6 text-lg text-gray-700'>{useCases[activeTab].description}</p>
              ...
              {useCases[activeTab].results.image ? (
                ...
                <div className='max-w-md mx-auto rounded-2xl bg-white p-8 text-center border border-gray-200'>
                  ...
                  <h4 className='mb-2 text-xl font-bold text-gray-800'>
                    {useCases[activeTab].results.title}
                  </h4>
                ...
                <div className='max-w-md mx-auto rounded-2xl bg-white p-8 text-center border border-gray-200'>
                  ...
                  <p className='mb-4 text-gray-700'>{useCases[activeTab].results.description}</p>
