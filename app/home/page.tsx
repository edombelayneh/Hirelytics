        ...
        <div className='container relative mx-auto px-6 py-24'>
          ...
          >
            ...
            <h1 className='mb-6 bg-gradient-to-r from-foreground to-foreground/70 bg-clip-text text-transparent'>
              Welcome to <span className='bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent'>Hirelytics</span>
            </h1>
            
            <p className='mb-10 text-xl text-muted-foreground max-w-2xl mx-auto'>
              Transform your job search with intelligent tracking, powerful analytics, 
              and organized application management. Land your dream job faster.
            </p>
            ...
            {[
              {
                step: '01',
                title: 'Browse Jobs',
                description: 'Explore our curated list of job openings from top companies across various industries.',
                icon: Briefcase
              },
              {
                step: '02',
                title: 'Apply & Track',
                description: 'Apply with one click and automatically add applications to your tracking dashboard.',
                icon: CheckCircle2
              },
              {
                step: '03',
                title: 'Monitor Progress',
                description: 'Track status updates, view analytics, and manage your entire job search journey.',
                icon: LineChart
              }
            ].map((step, index) => {
          ...
          <Card className='relative overflow-hidden border-2'>
            ...
            <div className='relative p-12 text-center'>
              ...
              <p className='text-xl text-muted-foreground mb-8 max-w-2xl mx-auto'>
                Join thousands of job seekers who have organized their applications and landed their dream jobs with Hirelytics.
              </p>
        ...
        <div className='container mx-auto px-6'>
          <div className='flex flex-col md:flex-row items-center justify-between gap-4'>
            ...
            <div className='flex gap-6 text-sm text-muted-foreground'>
              <a href='#/jobs' className='hover:text-foreground transition-colors'>Available Jobs</a>
              <a href='#/applications' className='hover:text-foreground transition-colors'>My Applications</a>
            </div>
          </div>
