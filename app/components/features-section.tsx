    ...
    <section id="features" className="py-20 bg-slate-50">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Features That Bring Transparency to Hiring</h2>
            <p className="text-lg text-slate-600 max-w-2xl mx-auto">
              Hirelytics delivers a modern hiring experience that empowers recruiters with efficiency and applicants with clarity.
            </p>
          </motion.div>
        </div>
